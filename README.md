...
если вы хотите чтобы ваша программа проработала не больше чем заданное количество часов: 
запустите ее таких образом, работает максимум 2 часа 30 минут: `app_runner.exe -2.5 my_app.exe`
если вы хотите чтобы ваша программа работала всю ночь и остановилась утром: 
запустите ее таких образом, работает до 7 утра: `app_runner.exe -7:00 my_app.exe`
если вы хотите остановить запущенную программу нажмите: Ctrl+C
во всех случаях в лог фале будет указана причина остановки: самостоятельное завершение программы, прерывание от пользователя или по времени
